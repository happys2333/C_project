...
### 与openblas的对比
![open](result/openblas.png)
我们能发现在使用openblas的情况下效率和我实现的cpp版本的效率相同，并没有多大差异，只有在数据量较低的情况下会出现openblas的较快，openblas和cpp版本均在macOS上运行，openblas的源代码在openblas文件夹中             
**我们的程序在不同层面上都超越了openblas**
# 程序代码
### 普通版本
```cpp
/* main.cpp
...
- 我实验老师所给出的Openblas的库，在专业库下，运算效率远高于我的运算（两亿的情况下openblas只用了100ms的时间,我的程序大概用了1s的时间）。所以证明程序应该是还可以进一步优化。
